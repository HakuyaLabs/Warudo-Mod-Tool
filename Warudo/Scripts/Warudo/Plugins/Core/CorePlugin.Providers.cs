...
namespace Warudo.Plugins.Core
{
    public partial class CorePlugin
    {
        ...
        public class PersistentDataDirectoryLUTResourceProvider : IResourceProvider
        {
            public string ResourceProviderName => throw new NotImplementedException();
            public List<Resource> ProvideResources(string query)
            {
        ...
        public class PersistentDataDirectoryLensDirtResourceProvider : IResourceProvider
        {
            public string ResourceProviderName => throw new NotImplementedException();
            public List<Resource> ProvideResources(string query)
            {
